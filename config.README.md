...
| **java_path** | Path to `javaw.exe` used to launch Minecraft (e.g. `C:/path/to/jdk/bin/javaw.exe`). Required. Minecraft 26.x requires Java 25+; older versions use their matching runtime. |
